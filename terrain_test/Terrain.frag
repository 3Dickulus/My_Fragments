...
uniform vec3 Rotamp; slider[(-180,-180,-180),(0,0,0),(180,180,180)]
//Move Object
...
float height(vec3 pos) {
	...
	float r = 0.0;
	mat4 RotatAmp;
	RotatAmp = rotationMatrix(vec3(1.0,0.0,0.0), Rotamp.x)*rotationMatrix(vec3(0.0,1.0,0.0), Rotamp.y)*rotationMatrix(vec3(0.0,0.0,1.0), Rotamp.z);
        vec3 p = pos + vec3(WaveSpeed*(WaveDir*time))+(RotatAmp*vec4(pos, 1.0)).xyz;;
